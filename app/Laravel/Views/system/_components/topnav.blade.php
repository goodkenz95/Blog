  ...
  <div class="container-fluid">
    <div class="be-right-navbar">
      <ul class="nav navbar-nav navbar-right be-user-nav">
        <li class="dropdown">
          ...
          <ul role="menu" class="dropdown-menu">
            ...
            <li><a href="{{route('system.account.profile',[Str::lower($auth->username)])}}"><span class="icon mdi mdi-face"></span> My Account</a></li>
      ...
      {{-- <ul class="nav navbar-nav navbar-right be-icons-nav"> --}}
        {{-- <li class="dropdown"><a href="#" role="button" aria-expanded="false" class="be-toggle-right-sidebar"><span class="icon mdi mdi-comment-text"></span></a></li> --}}
