          ...
          <table class="table table-hover table-wrapper">
            <thead>
              <tr>
                ...
                <th class="text-left" style="width:10%;" >Category</th>
            ...
            <tbody>
              ...
              <tr>
                ...
                <td class="cell-detail text-left"> 
                  <span><strong>{{Str::title($article->category?$article->category->name:NULL)}}</strong></span>
                </td>
                <td class="cell-detail">
                  <span>
                    ...
                    @else
                    @if($article->is_approved== "pending")
                    <div class="label label-default">Pending for Approval</div>
                    @else
