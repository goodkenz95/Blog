    ...
    <div class="main-content container-fluid">
      <div class="splash-container">
        ...
        <div class="panel panel-default panel-border-color panel-border-color-warning">
          <div class="panel-heading"><span class="splash-description">This is intended for all <strong>interns</strong> that doesn't have an account yet. <strong class="text-danger">Don't spread this link to avoid any consequences.</strong></span></div>
