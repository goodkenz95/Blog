          ...
          <table class="table table-hover table-wrapper">
            <thead>
              <tr>
                ...
                <th class="text-left" style="width:10%;" >Author</th>
            ...
            <tbody>
              ...
              <tr>
                <td class="cell-detail"> 
                  ...
                  <span class="cell-detail-description">{{"ID ".str_pad($page->id, 4, "0", STR_PAD_LEFT)}}</span>
                </td>
                <td class="cell-detail text-left"> 
                  <span><strong>{{Str::title($page->author?$page->author->name:NULL)}}</strong></span>
                </td>
                <td class="cell-detail">
                  <span>{{Helper::date_only($page->updated_at)}}</span>
                  <span class="cell-detail-description">{{Helper::date_format($page->updated_at,"h:i A")}}</span>
                </td>
                <td class="actions">
                    <div class="btn-group btn-hspace">
                      ...
                      <ul role="menu" class="dropdown-menu">
                        <li><a href="{{route('system.page.edit',[$page->id])}}">Edit Record</a></li>
                        {{-- <li class="divider"></li> --}}
                        {{-- <li><a class="action-delete" href="#" data-url="{{route('system.page.destroy',[$article->id])}}" data-toggle="modal" data-target="#confirm-delete" title="Remove Record">Remove Record</a></li> --}}
                      </ul>
                    </div>
                </td>
              </tr>
              @empty
              <td colspan="4" class="text-left"><i>No record found yet.</i> <a href="{{route('system.page.create')}}"><strong>Click here</strong></a> to create one.</td>
              @endforelse
            </tbody>
          </table>
