  ...
  <div class="row">
    <div class="col-md-6">
      ...
      <div class="panel panel-default panel-border-color panel-border-color-success">
        <div class="panel-heading panel-heading-divider">Create Employee Account Form<span class="panel-subtitle">Modify employee information.</span></div>
        <div class="panel-body">
          <form method="POST" action="">
            ...
            <div class="form-group {{$errors->first('fb_id') ? 'has-error' : NULL}}">
              ...
              <input type="text" placeholder="Your Facebook ID (serve as your avatar)" class="form-control" name="fb_id" value="{{old('fb_id')}}">
            ...
            <div class="form-group {{$errors->first('name') ? 'has-error' : NULL}}">
              ...
              <input type="text" placeholder="Complete name" class="form-control" name="name" value="{{old('name')}}">
            ...
            <div class="row xs-pt-15">
              <div class="col-xs-6">
                  <button type="submit" class="btn btn-space btn-success">Create Account</button>
